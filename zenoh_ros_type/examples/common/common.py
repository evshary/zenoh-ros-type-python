...
def add_config_arguments(parser: argparse.ArgumentParser):
    ...
    parser.add_argument(
        ...
        action='append',
        type=str,
        help='Allows arbitrary configuration changes as column-separated KEY:VALUE pairs. '
        'Where KEY must be a valid config path and VALUE must be a valid JSON5 string '
